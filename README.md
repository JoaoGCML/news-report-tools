...
| Button | Colour | When | Action |
|---|---|---|---|
| 🔗 Access | Blue | URL resolved | Direct link to the original article (resolved via DuckDuckGo) |
| 🔍 Quick Search | Yellow | Always | Broad Google search — no quotes, no site restriction |
